...
- Dashboard → Auswahlmodus „Stundenplan (aktuelle Woche)“: Jede Stunde zeigt jetzt dezent die Anzahl der UE neben der Uhrzeit an (z. B. „2 UE“ bei einer Doppelstunde), abgeleitet aus dem UE-Wert der Stunde (siehe Admin → UE-Zeiten).
...
- WebUntis-Fachkürzel prüfen (`teacher/webuntis_review.php`): Wurde ein Kürzel (z. B. „SPRE“ für Sprechstunde) einem Fach zugeordnet oder als „keine Unterrichtsstunde“ markiert, blieben Termine mit demselben Kürzel in abweichender Schreibweise (z. B. „Spre“) oder mit geschütztem Leerzeichen weiterhin unzugeordnet, obwohl die Übersichtsseite wegen der datenbankseitig groß-/kleinschreibungsunabhängigen Gruppierung nur ein einziges, bereits erledigt wirkendes Kürzel anzeigte. Der Abgleich beim Import vereinheitlicht Groß-/Kleinschreibung und Leerraum jetzt genauso wie die Übersichtsseite, sodass alle Schreibweisen desselben Kürzels korrekt erkannt werden.
- WebUntis-Fachkürzel prüfen: Termine ohne Titel im Feed (leeres Kürzel) ließen sich nicht als „keine Unterrichtsstunde“ markieren – die Speicherfunktion verlangte zwingend ein Fachkürzel. Das ist jetzt möglich; die Übersichtsseite zeigt solche Termine als „ohne Titel im Feed“ statt als leere Anführungszeichen an. Einem titellosen Termin ein Fach zuzuordnen bleibt weiterhin gesperrt, da es kein Unterscheidungsmerkmal zu anderen titellosen Terminen gäbe.
- WebUntis-Import: Auch nach einer Zuordnungsentscheidung (Fach oder „keine Unterrichtsstunde“) blieb ein Teil der Termine mit demselben Kürzel weiterhin als unzugeordnet stehen. Zwei Ursachen behoben: (1) Termine ohne eigene UID im Feed (typisch bei Terminen ohne Titel) erzeugten bei jedem Import eine neue Zeile statt eine bestehende zu aktualisieren, wodurch alte Zeilen nie als erledigt markiert wurden – der Abgleich erkennt solche Termine jetzt zusätzlich an Kürzel, Datum und Uhrzeit. (2) Termine, deren WebUntis-Vorkommen (z. B. wegen einer Absage) nicht mehr im aktuellen Import-Durchlauf auftauchten, blieben als Karteileiche für immer „unzugeordnet“ stehen – solche Zeilen werden jetzt wie bereits importierte Stunden automatisch bereinigt, sobald der jeweilige Termin innerhalb des vom Feed abgedeckten Zeitraums nicht mehr bestätigt wird.
